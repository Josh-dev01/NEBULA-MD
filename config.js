...
module.exports = {
 ...
 SESSION_ID: process.env.SESSION_ID || "Nebula~ZdMBSJpT#MCdLnSdwicQK28ZuCydoeAIFQxrwo74GCVUAA-pwz_k",
  PREFIX: getConfig("PREFIX") || ".",
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*‎✦『ᴶᴼˢᴴᵁᴬᴹᴬᴹᴮᴼ1』✦" MD VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://b.top4top.io/p_3291qwfqu0.jpg  // Bot's "alive" menu mention image
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ‎Ⓙ🅞Ⓢ🅗_🄺🅸🄽🅶_ⓉⒺⒸⒽ*",  // Bot description
